export const personalInfo = {
  ...
  roles: ['Low Level Programmer', 'Smart Contract Developer', 'Reverse Engineer', 'Systems Programmer'],
...
export const certifications = [
  {
    ...
    url: 'https://www.credly.com/badges/36f88330-5d3d-4b2c-9369-4ec7baa38714/linked_in_profile',
  },
  {
    title: 'QuickHeal Digital Forensics',
    issuer: 'QuickHeal',
    year: 'Mar 2026',
    icon: '🔍',
    color: '#00FF41',
    description: 'Digital Forensics and Incident Response methodologies.',
    url: 'https://lms.quickhealacademy.com/certificates/verification/exam?id=LPU-0000-606659',
  },
  {
